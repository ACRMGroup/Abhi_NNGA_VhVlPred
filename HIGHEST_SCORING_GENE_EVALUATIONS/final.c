...
static double correlationCoefficientOrError=0;

static struct residue_properties residueProperties;

char trainingBoundaryString[20];

static BOOL writeOutputToFileFlag=FALSE;
...
int main(int argc,char **argv)
{
   ...
   */
   ...
   {
      strcpy(snnsFilenames.coefficientOutputFilename,outputFilename);
   }
   ...
   */
   ...
   correlationCoefficientOrError = calculate_coefficient_over_single_fold(geneScoreGen.gene,
